...
router.post('/create-commande',authorize([LOGGED_USER,SUPER_ADMIN]),validateCommande, createCommande);
...
router.get('/get-my-commande',authorize([LOGGED_USER,SUPER_ADMIN]), getCommandeByMyId );
