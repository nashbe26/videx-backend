...
router.post('/add-prod-to-fav',authorize([LOGGED_USER,SUPER_ADMIN]),  userController.addToFav);
router.post('/delete-prod-to-fav',authorize([LOGGED_USER,SUPER_ADMIN]),  userController.deleteToFav);
