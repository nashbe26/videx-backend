...
const { uploadMultiImages, multiUploadImages } = require('../utils/multer');

router.post('/create-product',validateProduct,  productController.createProduct);
...
router.put('/update-product/:id',validateProduct, productController.updateProductById);
